...
Button_Close:loadTextureNormal("assets/button/close_normal.png",0)
Button_Close:loadTexturePressed("assets/button/close_normal.png",0)
...
Button_Close:setPosition(349.5, 336.5)
...
layout:setRightMargin(-424.5)
layout:setTopMargin(-409.5)
